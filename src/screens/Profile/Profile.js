...
const ProfilePage = () => {
  ...
  const { formetedProfileData, refreshProfile, isLoggedIn } =
  ...
  const updateProfile = async () => {
    ...
    try {
      ...
      if (response.ok && result.success) {
        ...
        const errorMessage =
          result.message || `Profile update failed. Status: ${response.status}`
    ...
    >
        ...
        <View style={styles.contentContainer}>
          ...
          >
            <View style={styles.inputGroup}>
              <Text style={[styles.label, { color: branding.textColor }]}>
                Full Name
              </Text>
              <TextInput
                style={[
              ...
              <View style={styles.toggleContainer}>
                <View style={styles.toggleLabelContainer}>
                  <Text
                    style={[
                      styles.label,
                      { color: branding.textColor, marginBottom: 0 }
                    ]}
                  >
                    Hide Phone Number
                  </Text>
                  <Text
                    style={[
                      ...
                      { color: branding.textColor + 'CC' }
                    ]}
                  >
                    Hide your phone number from product detail pages
                  </Text>
                </View>
                <Switch
                  trackColor={{
                    false: branding.textColor + '40',
                    true: branding.primaryColor + '80'
                  }}
                  thumbColor={
                    hidePhoneNumber ? branding.primaryColor : '#f4f3f4'
                  }
                  ios_backgroundColor={branding.textColor + '40'}
            ...
            <View style={styles.sectionHeader}>
              <Text
                style={[styles.sectionTitle, { color: branding.primaryColor }]}
              >
                Security
              </Text>
              <View
                style={[
                  styles.divider,
                  { backgroundColor: branding.primaryColor + '40' }
                ]}
              />
            </View>
      ...
      >
        {loading ? (
          ...
          <Text
            style={[styles.saveButtonText, { color: branding.backgroundColor }]}
          >
            Save Changes
          </Text>
        )}
