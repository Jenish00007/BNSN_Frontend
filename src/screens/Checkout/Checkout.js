...
function Checkout(props) {
    ...
    props.navigation.setOptions({
      headerTitle: () => (
        <View style={{ alignItems: 'center', gap: scale(2) }}>
          ...
          <TextDefault
            style={{ color: branding.textColor, ...textStyles.H5 }}
          >
    ...
    if (checkPaymentMethod(configuration.currency)) {
      ...
      mutateOrder({
        variables: {
          ...
          address: {
            label: location?.label || 'defaultLocation',
            deliveryAddress: location?.deliveryAddress || 'Location not available',
  ...
  function loadginScreen() {
    return (
      <View style={[styles(currentTheme).screenBackground, { backgroundColor: branding.backgroundColor }]}>
        <Placeholder
          Animation={(props) => (
            <Fade
              {...props}
              style={[styles(currentTheme).placeHolderFadeColor, { backgroundColor: branding.secondaryColor }]}
              duration={600}
            />
          )}
    ...
    <>
      <View style={[styles(currentTheme).mainContainer, { backgroundColor: branding.backgroundColor }]}>
          ...
          <>
            ...
            >
              <View>
                ...
                <View style={[styles(currentTheme).headerContainer]}>
                  <Location
                    locationIcon={branding.primaryColor}
                    locationLabel={branding.textColor}
                    location={branding.textColor}
        ...
        >
          <View style={styles().modalContainer}>
            ...
            <View style={{ gap: 8 }}>
              <TextDefault uppercase bold textColor={branding.textColor}>
                {t('enterCode')}
              </TextDefault>
              <TextInput
            ...
            >
              <TextDefault
                textColor={branding.backgroundColor}
                style={styles().checkoutBtn}
                bold
                H4
              >
      ...
      >
        <PickUp
          ...
          orderDate={orderDate}
          pickupTextColor={branding.textColor}
        />
        <TouchableOpacity
          onPress={() => {
