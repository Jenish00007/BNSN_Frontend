            ...
            <View style={styles().flex}>
              <View style={styles().mainContentContainer}>
                <View style={[styles().flex, styles().subContainer]}>
                  <Animated.FlatList
                    contentInset={{ top: safeContainerPaddingTop }}
                    contentContainerStyle={{
                      paddingTop: Platform.OS === 'ios' ? 0 : safeContainerPaddingTop
                    }}
                    contentOffset={{ y: -safeContainerPaddingTop }}
                    onScroll={onScroll}
                    scrollIndicatorInsets={{ top: safeScrollIndicatorInsetTop }}
