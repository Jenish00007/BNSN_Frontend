    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.content}>
          ...
          <Text style={styles.paragraph}>
            For any questions about our cancellation policy or assistance with cancelling an order, please contact our customer support team at {config?.contactInfo?.email || '7ark.ynm@gmail.com'}
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
