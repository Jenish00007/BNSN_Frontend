    ...
    <View style={styles.container}>
      <View style={styles.itemWrapper}>
        <TouchableOpacity onPress={() => navigation.navigate('ProductDetail', { product: item })} activeOpacity={0.8}>
          <View style={[styles.itemContainer, { backgroundColor: branding.backgroundColor }]}>
            ...
            {getUnitCountDisplay() && (
              <View style={[styles.unitCountContainer, { backgroundColor: branding.primaryColor }]}>
            ...
            <View style={styles.cardFooterRow}>
              <View style={styles.priceContainer}>
                <Text style={[styles.cardPriceCurrency, { color: branding.textColor }]}>₹</Text>
                <Text style={[styles.cardPrice, { color: branding.textColor }]}>{item.price}</Text>
              </View>
